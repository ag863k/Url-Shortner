...
const AboutPage = () => {
  return (
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2 bg-gray-900">
      <div className="bg-gray-900 w-full sm:py-10 py-8  ">
        <h1 className="sm:text-4xl text-green-400 text-3xl font-bold italic  mb-3">
          About GoLinkly
        </h1>
        <p className="text-gray-300 text-sm  mb-8 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full ">
          ...
          trackable links for enhanced digital presence. Effortlessly create,
          organize, and monitor your shortened links. GoLinkly transforms long
          URLs into smart, trackable links for enhanced digital presence.
        </p>
