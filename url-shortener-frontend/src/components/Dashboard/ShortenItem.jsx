    ...
    <div className={`flex sm:flex-row flex-col  sm:justify-between w-full sm:gap-0 gap-5 py-5 `}>
      <div className="flex-1 sm:space-y-1 max-w-full overflow-x-auto overflow-y-hidden ">
        <div className="text-slate-900 pb-1 sm:pb-0   flex items-center gap-2 ">
            ...
            <Link
              target='_'
              className='text-[17px]  font-montserrat font-[600] text-green-600'
        ...
        <div className="flex  flex-1  sm:justify-end items-center gap-4">
            ...
            >
                <div className="flex cursor-pointer gap-1 items-center bg-green-600 hover:bg-green-700 py-2  font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white ">
            ...
            <div
                ...
                className="flex cursor-pointer gap-1 items-center bg-green-700 hover:bg-green-800 py-2 font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white "
            >
